...
class ARTEMISExecutor(object):
    def __init__(self, train_loader, test_loader, criterion, eval_metric, class_list, test_every, distributed,
        ...
        model = ARTEMIS(class_embed, num_frames, recurrent, fusion, residual, relu,
...
if __name__ == '__main__':
    ...
    model = ARTEMIS(torch.rand((140, 512), ), 16, 'bilstm', 'normal', False, False,

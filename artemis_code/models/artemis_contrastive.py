...
class ARTEMISContrastive(nn.Module):
    def __init__(self, class_embed, num_frames, recurrent: str | None = None, fusion: str = 'normal',
        ...
        super(ARTEMISContrastive, self).__init__()
...
class ARTEMISContrastiveExecutor(object):
    def __init__(self, train_loader, test_loader, criterion, eval_metric, class_list, test_every, distributed,
        ...
        model = ARTEMISContrastive(class_embed, num_frames, recurrent, fusion, residual, relu,
